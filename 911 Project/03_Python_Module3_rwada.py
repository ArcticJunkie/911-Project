...
#counter.
for index, val in enumerate([10, 20, 30],200):
    print(index,val)
...
#using a facility called lambda function. lambda functions are small functions 
#usually not more than a line. ... 
#The result of the expression is the value when the lambda is applied to an 
argument
...
# fun1(a=10,c=20,b=45,d=10) # keyword notation
...
greet("Monica","Luke","Steve","John","Bill","edureka","Jon")
...
# print(format_name('Python', 'Spark',reverse=False))
